...
For additions to the roadmap, view our relevant documentation files:

- [Roadmap style guide](docs/style-guide.md)
- [Individual item template](docs/item-template.md)
- [Bulk roadmap updates RFC template](docs/rfc-template.md)

## What goes on the roadmap

Our project roadmap follows a very specific process, documented here.
...
Proposed roadmap items should provide enough details to fill in the relevant sections of our [roadmap item template](docs/item-template.md).
